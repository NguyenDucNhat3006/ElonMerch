...
// Import ảnh ticket và các banner để truyền dữ liệu
...
const mockEvents = {
  "1": {
    ...
    date: '19:30 - 22:30, 30 Tháng 04, 2026',
    location: 'Sân Khấu Nhà Thiếu Nhi TP.HCM',
    vipPrice: 350000,
    regPrice: 300000,
    img: leChiVien // Bổ sung ảnh banner vào data
  },
  "2": {
    id: "2",
    title: 'Soobin Live Concert - All Rounder',
    date: '19:30 - 23:00, 05 Tháng 05, 2026',
    location: 'The Global City, TP. Thủ Đức',
    vipPrice: 1500000,
    regPrice: 800000,
    img: ban2 // Bổ sung ảnh banner vào data
  },
  "3": {
    id: "3",
    title: 'Workshop: Làm nến thơm cùng Elon',
    date: '09:00 - 11:30, 25 Tháng 04, 2026',
    location: 'Elon Merch Studio, Quận 1',
    vipPrice: 500000,
    regPrice: 200000,
    img: 'https://picsum.photos/seed/ws/400/250'
  }
};
...
const TicketBookingPage = () => {
  ...
  const handleAddAndGo = () => {
    selectedSeats.forEach(seat => {
      addToCart({
        ...
        price: seat.price,
        quantity: 1,
        // THAY ĐỔI: Sử dụng ảnh banner của show thay vì logoticket
  ...
  return (
        ...
        <div className="max-w-4xl mx-auto bg-white rounded-[40px] shadow-sm p-10 border border-blue-50">
          <div className="flex justify-center gap-12 mb-16">
            <div className="flex items-center gap-3 text-slate-500 font-bold">
              <img src={iconTicket} className="w-8 h-8 object-contain" alt="Empty" />
              Vé trống
            </div>
            <div className="flex items-center gap-3 text-slate-500 font-bold">
              <img src={iconTicket} className="w-8 h-8 object-contain hue-rotate-[140deg] saturate-[3] brightness-110" alt="Selecting" />
              Đang chọn
            </div>
            <div className="flex items-center gap-3 text-slate-500 font-bold">
              <img src={iconTicket} className="w-8 h-8 object-contain hue-rotate-[220deg] saturate-[5] brightness-90" alt="Booked" />
              Đã chọn
            </div>
          </div>

          <div className="w-3/4 mx-auto mb-16">
            <div className="bg-[#7F89C5] text-white text-center py-3 rounded-xl font-black tracking-[0.2em] shadow-lg">
              SÂN KHẤU
            </div>
          </div>
        ...
        <div className="p-8 space-y-8 flex-1">
          ...
          <div className="space-y-6">
            ...
            <div className="flex justify-between items-start">
              <div>
                <p className="font-black text-sm uppercase">HẠNG VIP</p>
                <p className="text-[10px] opacity-70 italic font-bold">Hàng 1 2 3</p>
              </div>
              <p className="font-black text-lg">{currentEvent.vipPrice.toLocaleString()} VNĐ</p>
            </div>
            <div className="flex justify-between items-start">
              <div>
                <p className="font-black text-sm uppercase">HẠNG REGULAR</p>
                <p className="text-[10px] opacity-70 italic font-bold">Hàng 4 5 6 7 8</p>
              </div>
    ...
    ${selectedSeats.length > 0
                ? 'bg-[#4054B2] text-white hover:bg-blue-800 hover:scale-[1.02] active:scale-95 shadow-blue-500/20'
